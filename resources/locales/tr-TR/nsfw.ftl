...
command-no-images-found = Üzgünüm, sizin için bir resim bulamadım! Lütfen birazdan tekrar deneyin. { $emoji }
...
msg-invite-me = Beni davet et!
msg-premium = Premium
msg-discord-server = Discord Sunucusu
