...
posts-desc =
    ...
    - If you want to delete the alert you can use the same command, and click on the "Disable" button.
posts-message = Melding
# max.length: 80
posts-settings-msg-btn = Rediger melding
# max.length: 45
...
# max.length: 100
alerts_streams_youtube-parameter-user_name_or_id-description = YouTube-kanalens navn eller ID.
# max.length: 100
...
# max.length: 100
help-alerts_streams_kick = Administrer en direktemelding for en kick bruker.
# max.length: 100
