...
slash-help-msg-cmds = Comandos de mensagem:
...
si-emojis-disabled = Desativados
si-stickers = Figurinhas:
si-roles = Cargos:
si-upload-limit = Limite de upload:
si-audio-bitrate-max = Taxa de bits máxima por áudio:
si-is-martine-premium = Premium:
si-server-banner = Banner do servidor
si-inv-bg = Fundo do convite do servidor
si-features-field = Funcionalidades:
...
ui-app-misc = Outros
ui-app-guildcount = Contagem aproximada de servidores
...
ci-user-limit = Limite de usuários
...
sti-type = Tipo
sti-server = Figurinha do servidor
sti-emoji = Emoji
