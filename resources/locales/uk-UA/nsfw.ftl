...
amount-too-low = Вибачте, але параметр кількості має бути меншим за 1 зображення! { $emoji }
amount-too-high = Вибачте, але параметр кількості має бути меншим або дорівнювати { $amount } зображень! { $emoji }
