...
# max.length: 100
streams-msg-placeholder = { "{" }streamer{ "}" } = El nombre del streamer. - { "{" }everyone{ "}" } = @everyone - { "{" }here{ "}" } = @here
...
# max.length: 100
videos-msg-placeholder = { "{" }streamer{ "}" } = creador del video - { "{" }everyone{ "}" } = @everyone - { "{" }here{ "}" } = @here
