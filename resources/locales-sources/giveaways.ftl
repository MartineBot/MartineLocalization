...
giveaway-roll-notfound = The message of giveaway { $prize } seems to have been deleted.
    I cannot roll out winners.
giveaway-roll-reroll = Giveaway reroll! { $emoji }
giveaway-roll-ended = Giveaway ended! { $emoji }
giveaway-roll-description = Congratulations to the **{ $num_winners } { $num_winners ->
        [one] winner
       *[other] winners
    }
    You have won { $prize }!**
giveaway-roll-total-entries = { $num_entries_fmt } total { $num_entries ->
        [one] entry
       *[other] entries
    }!
giveaway-roll-gg = Congratulation { $winners }!
giveaway-roll-nothing = But no one entered. { $emoji }
    It was { $prize }
...
giveaway-btn-denied-title = Giveaway entry denied! Missing { $count ->
        [one] requirement
       *[other] requirements
}
...
giveaway-setup-timeout = { $giveaway-setup-cancelled }
    User took too much time to answer.
giveaway-setup-too-many-fails = { $giveaway-setup-cancelled }
    User failed to give an good answer after 5 tries.
giveaway-setup-title = __You have started the giveaway setup. You will have 5 minutes to answer each questions.__
...
giveaway-setup-roles = Which role(s) will be allowed to enter that giveaway? In the case of multiple roles, please use commas to separate them.
...
giveaway-setup-roles-condition = Do you want to require members to have any or all of the roles you specified?
...
giveaway-setup-emoji = Which emoji do you want with the button on which people can enter?
...
giveaway-setup-channel-missing-perms = Please make sure I have the following permissions in the wanted channel:
