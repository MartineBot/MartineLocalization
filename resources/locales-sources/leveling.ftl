...
disabled-msg = Leveler is not enabled in this server.
...
rep-cooldown = Oops, you are on cooldown on giving rep points! { $emoji }
    Try again { $formatted_cooldown }
rep-success = { $member } you have just received a reputation point from { $author }!
